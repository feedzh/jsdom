...
exports.stringifyElement = function stringifyElement(element, options) {
  ...
  if((singleTags[tagName])&&(!options.xmlMode)) {
    ret.start += " />";
    ret.end = '';
  } else {
    ret.start += ">";
...
exports.makeHtmlGenerator = function makeHtmlGenerator(indentUnit, eol, options) {
    ...
    if (node) {
      ...
      switch (node.nodeType) {
        case node.ELEMENT_NODE:
          current = exports.stringifyElement(node, options);
...
exports.domToHtml = function(dom, noformat, raw, options) {
